...
int main( int argc, char** argv )
{
    ...
    Mat imageInput = imread("/home/reid/catkin_ws/src/pcl_test/image/tof_rgb/0_rgb.png");
...
*/
    ...
    model_points.push_back(Point3d(0.05f, 0.0f, 0.0f));
    model_points.push_back(Point3d(0.0f, 0.05f, 0.0f));
    model_points.push_back(Point3d(0.05f, 0.05f, 0.0f));
/*
...
//     cout << "transform_1_inverse_no_t is "  << transform_1_inverse << endl;
    ...
    model_points_test.push_back(Point3f(0.1,0,0));
